...
public class Graph
{
    ...
    {
        Vertex vertex;
        vertex = myVertices.get(name);
        if (vertex == null)
        {
            vertex = new Vertex(name);
            myVertices.put(name, vertex);
            myAdjList.put(vertex, new TreeSet<Vertex>());
            myNumVertices += 1;
        }
        return vertex;
    }
    ...
    public void printBFT(String nameOriginVertex)
    {
        Vertex originVertex = getVertex(nameOriginVertex);
